...
Ncal=length(ab);
load xmedia_mod_1.mat
X=xm'; % modelo estimado
...
leg = legend('Resistividade aparente obs','Resistividade aparente cal'); 
%%
...
title(['\bf \fontsize{12} \fontname{Times}Modelo']);
leg = legend('Real','Estimado'); 
