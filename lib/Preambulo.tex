...
\usepackage[linesnumbered,commentsnumbered,lined,boxed,ruled]{algorithm2e}
...
% Referências
\usepackage[alf, bibjustif, abnt-etal-list=0, abnt-etal-text=it,abnt-emphasize=bf]{abntex2cite}
